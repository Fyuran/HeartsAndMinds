...
/* ----------------------------------------------------------------------------
Function: btc_log_fob_fnc_logObj
...
Examples:
    (begin example)
        _result = [cursorObject] spawn btc_log_fob_fnc_logObj;
    (end)
...
[_flag, getPosATL _create_obj, [vectorDir _create_obj, vectorUp _create_obj]] remoteExecCall ["btc_log_fob_fnc_logObj_s", [0, 2] select isMultiplayer];
