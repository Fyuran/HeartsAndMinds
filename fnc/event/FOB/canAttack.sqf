...
private _flag = _building getVariable["FOB_Flag", objNull];
_flag setVariable["FOB_Event", true, true]; //publicVariable for clients to handle ace interaction menu condition check
_building setVariable ["FOB_Event", true, true];
_BIS_respawn_EH = _building getVariable["FOB_Respawn_EH", []];
...
[[_building, _flag, _nearCities], {
    ...
    _statement = {
        params["_building", "_flag", "_groups"];
