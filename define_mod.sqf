...
btc_city_blacklist = [];
btc_city_blacklist_pos = [ // [center:2D/3D position, x, y, angle, isRectangle, z:OPTIONAL]
]; 
...
private _KAT = [
    "kat_plate","kat_clamp","kat_vacuum","kat_etomidate","kat_flumazenil","kat_lorazepam","kat_retractor",
    "kat_scalpel","kat_amiodarone","kat_atropine","kat_EACA","kat_fentanyl","kat_ketamine","kat_lidocaine",
    "kat_nalbuphine","kat_naloxone","kat_nitroglycerin","kat_TXA","kat_IV_16","kat_aatKit","kat_accuvac",
    "kat_X_AED","Attachable_Helistretcher","kat_AED","kat_crossPanel","kat_BVM","kat_chestSeal","kat_IO_FAST",
...
private _items = [
    "ItemMap", "ItemCompass", "ItemWatch" ,"ToolKit", "MineDetector"
];
private _backpacks = ["B_Kitbag_mcamo"];
