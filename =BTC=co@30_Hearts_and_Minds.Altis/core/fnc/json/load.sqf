...
if(isNil "btc_JSON_data") exitWith {
    private _returnString = ("btc_ArmaToJSON" callExtension ["getData", [format["btc_hm_%1", _name]]]) select 0;
    [_returnString, 1, [1,0.27,0,1]] call CBA_fnc_notify;
};
...
["Database loaded", 1, [0,1,0,1]] call CBA_fnc_notify;