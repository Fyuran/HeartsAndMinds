...
//add actions to keys
private _actionEH = [player, "DefaultAction", {[player, objNull, []] call ace_common_fnc_canInteractWith}, {btc_log_placing = false;}] call ace_common_fnc_addActionEventHandler;
...
[{
    ...
    params [
            "_placing_obj", "_currentWeapon", "_actionEH", "_keyDownEH", "_MouseZChangedEH"
        ];
...
}, [_placing_obj, _currentWeapon, _actionEH, _keyDownEH, _MouseZChangedEH]] call CBA_fnc_waitUntilAndExecute;
