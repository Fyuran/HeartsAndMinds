class Params {
    ...
    class btc_p_eh_sunriseorsunset { // Keep daylight or night
        title = __EVAL(format ["      %1", localize "STR_BTC_HAM_PARAM_SUNRISEORSUNSET_TITLE"]);
        values[]={0,1,2};
        texts[]={$STR_BTC_HAM_PARAM_EH_SUNSET, $STR_BTC_HAM_PARAM_EH_SUNRISE, $STR_DISABLED};
        default = 1;
    };
    ...
    class btc_p_air { // Enemy uses Air:
        title = __EVAL(format ["      %1", localize "STR_BTC_HAM_PARAM_FAC_EAIR"]);
        values[]={0,1};
        texts[]={$STR_DISABLED,$STR_ENABLED};
        default = 0;
    };
    ...
    class btc_p_fob_disable_destruction { // Disable FOB destruction:
        title = __EVAL(format ["      %1", localize "STR_BTC_HAM_PARAM_GAMEPLAY_FOBDESTRUCTION"]);
        values[] = {0,1};
    ...
    class btc_p_log_cost_multiplier { // Log objects cost multiplier:
        title = __EVAL(format ["      %1", localize "STR_BTC_HAM_PARAM_GAMEPLAY_LOGCOST"]);
