...
private _p_en_air = ("btc_p_air" call BIS_fnc_getParamValue) isEqualTo 1;
...
btc_log_fob_create_obj_class = "CargoNet_01_box_F";
...
btc_debug_isUsingMapToPlace = false; //avoid teleportation for map clicks in debug mode
...
_allclasse = [[_p_en], _p_en_AA, _p_en_tank, _p_en_air] call btc_mil_fnc_class; //Create classes from factions, you can combine factions like that: [[_p_en , "IND_F"], _p_en_AA, _p_en_tank] call btc_mil_fnc_class;
...
//Tasks
btc_side_taskIDs = createHashMap;
