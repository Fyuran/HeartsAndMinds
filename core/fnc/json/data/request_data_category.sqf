...
if(!params[
	...
	[["%1: Invalid params", __FILE_NAME__], 6, "json/data"] call btc_debug_fnc_message;
};
...
[["%1: %2, pieces:%3", __FILE_NAME__, _category, _pieces], 2, "json/data"] call btc_debug_fnc_message;
#endif
...
for "_i" from 0 to (_pieces - 1) do {
	...
	#ifdef BTC_DEBUG_JSON
	[["%1: Loading JSON Data returned for %2(%3)", __FILE_NAME__, _category, _piece], 2, "json/data"] call btc_debug_fnc_message;
	#endif
