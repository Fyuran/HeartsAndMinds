...
_action = ["side_mission_abort", localize "STR_BTC_HAM_ACTION_SIDEMISSION_ABORT", "\A3\ui_f\data\igui\cfg\simpleTasks\types\exit_ca.paa", {[player call BIS_fnc_taskCurrent] call FUNC(task,abort)}, {true}] call ace_interact_menu_fnc_createAction;
...
if(btc_db_load == 1) then { // If is JSON
    _action = ["request_json_fileviewer", "JSON File Viewer", "core\img\json.paa", {
        [{[] call FUNC(db,fileviewer);}] call CBA_fnc_execNextFrame; //without this, game will crash
    }, {(call BIS_fnc_admin) == 2 || isServer}] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions"], _action] call ace_interact_menu_fnc_addActionToObject;
};
...
_action = ["Search_intel", localize "STR_A3_Showcase_Marksman_BIS_tskIntel_title", "\A3\ui_f\data\igui\cfg\simpleTasks\types\search_ca.paa", {
    [FUNC(info,search_for_intel), [_target]] call CBA_fnc_execNextFrame;
...
//Log point
{
    ...
    _action = ["Repair_wreck", localize "STR_BTC_HAM_ACTION_LOGPOINT_REPWRECK", "\A3\ui_f\data\igui\cfg\simpleTasks\types\repair_ca.paa", {
        ...
        _actionParams call FUNC(log,repair_wreck)
    ...
    _action = ["Copy_container", localize "STR_BTC_HAM_ACTION_COPYPASTE_COPY", "\A3\ui_f\data\igui\cfg\simpleTasks\types\download_ca.paa", {
        params ["", "", "_actionParams"];
        _actionParams call FUNC(log,copy)
    }, {true}, {}, [_log_point], [0, 0, 0.4], 5] call ace_interact_menu_fnc_createAction;
    ...
    _action = ["Paste_container", localize "STR_BTC_HAM_ACTION_COPYPASTE_PASTE", "\A3\ui_f\data\igui\cfg\simpleTasks\types\upload_ca.paa", {
        params ["", "", "_actionParams"];
        [btc_copy_container, _actionParams] call FUNC(log,paste)
    ...
    _action = ["Copy_inventory", localize "STR_BTC_HAM_ACTION_COPYPASTE_COPYI", "\A3\ui_f\data\igui\cfg\simpleTasks\types\download_ca.paa", {
        params ["", "", "_actionParams"];
        _actionParams call FUNC(log,inventoryCopy)
    }, {true}, {}, [_log_point], [0, 0, 0.4], 5] call ace_interact_menu_fnc_createAction;
    [_object, 0, ["ACE_MainActions", "Tool"], _action] call ace_interact_menu_fnc_addActionToObject;
    _action = ["Paste_inventory", localize "STR_BTC_HAM_ACTION_COPYPASTE_PASTEI", "\A3\ui_f\data\igui\cfg\simpleTasks\types\upload_ca.paa", {
        params ["", "", "_actionParams"];
        [btc_copy_inventory, _actionParams] call FUNC(log,inventoryPaste)
    ...
    _action = ["Restore_inventory", localize "STR_BTC_HAM_ACTION_RESTOREI", "\A3\Ui_f\data\GUI\Cfg\KeyframeAnimation\IconCurve_CA.paa", {
        params ["", "", "_actionParams"];
        _actionParams call FUNC(log,inventoryRestore)
    }, {true}, {}, _log_point, [0, 0, 0.4], 5] call ace_interact_menu_fnc_createAction;
    [_object, 0, ["ACE_MainActions", "Tool"], _action] call ace_interact_menu_fnc_addActionToObject;
    ...
    if (btc_p_respawn_ticketsAtStart isNotEqualTo -1) then {
        _action = ["Bodybag", localize "STR_BTC_HAM_ACTION_LOGPOINT_BODYBAG", "\A3\Data_F_AoW\Logos\arma3_aow_logo_ca.paa", {
            params ["", "", "_actionParams"];
            _actionParams call FUNC(body,bagRecover);
        }, {true}, {}, [_log_point], [0, 0, 0], 5] call ace_interact_menu_fnc_createAction;
        [_object, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToObject;
    };
...
//FOB
_action = ["Mount_FOB", localize "STR_BTC_HAM_ACTION_FOB_MOUNT", "\A3\Ui_f\data\Map\Markers\NATO\b_hq.paa", {_target spawn FUNC(fob,create)}, {!btc_log_placing && {!(player getVariable ["ace_dragging_isCarrying", false]) && {!(_target getVariable ["btc_log_isBeingPlaced", false])}}}] call ace_interact_menu_fnc_createAction;
...
private _action = ["btc_jail_placeJail", localize "STR_BTC_HAM_ACTION_PLACE_JAIL", "core\img\jail_captive.paa", {
    [_target] spawn FUNC(jail,createJail);
}, {
...
_action = ["btc_fob_log_createLogObj", localize "STR_BTC_HAM_ACTION_PLACE_LOG_OBJ", "\z\ace\addons\dragging\UI\icons\box_carry.paa", {
    [_target] spawn FUNC(log_fob,create);
}, {
...
_action = ["Civil_Stop", localize "STR_BTC_HAM_ACTION_ORDERS_STOP", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk3_ca.paa", {[1] call FUNC(int,orders);}, {vehicle player isEqualTo player}] call ace_interact_menu_fnc_createAction;
[player, 1, ["ACE_SelfActions", "Civil_Orders"], _action] call ace_interact_menu_fnc_addActionToObject;
_action = ["Civil_Get_down", localize "STR_BTC_HAM_ACTION_ORDERS_GETDOWN", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk2_ca.paa", {[2] call FUNC(int,orders);}, {vehicle player isEqualTo player}] call ace_interact_menu_fnc_createAction;
[player, 1, ["ACE_SelfActions", "Civil_Orders"], _action] call ace_interact_menu_fnc_addActionToObject;
_action = ["Civil_Go_away", localize "STR_BTC_HAM_ACTION_ORDERS_GOAWAY", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk1_ca.paa", {[3] call FUNC(int,orders);}, {vehicle player isEqualTo player}] call ace_interact_menu_fnc_createAction;
[player, 1, ["ACE_SelfActions", "Civil_Orders"], _action] call ace_interact_menu_fnc_addActionToObject;
...
{ //Actions attachted to AI
    ...
    [_x, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToClass;
    _action = ["Civil_taxi", localize "STR_BTC_HAM_ACTION_ORDERS_TAXI", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk4_ca.paa", {[4, _target] call FUNC(int,orders);}, {(alive _target) && (vehicle _target) isNotEqualTo _target}] call ace_interact_menu_fnc_createAction;
    [_x, 0, ["ACE_MainActions", "Civil_Orders"], _action] call ace_interact_menu_fnc_addActionToClass;
    _action = ["Civil_Stop", localize "STR_BTC_HAM_ACTION_ORDERS_STOP", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk3_ca.paa", {[1, _target] call FUNC(int,orders);}, {alive _target}] call ace_interact_menu_fnc_createAction;
    [_x, 0, ["ACE_MainActions", "Civil_Orders"], _action] call ace_interact_menu_fnc_addActionToClass;
    _action = ["Civil_Get_down", localize "STR_BTC_HAM_ACTION_ORDERS_GETDOWN", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk2_ca.paa", {[2, _target] call FUNC(int,orders);}, {alive _target}] call ace_interact_menu_fnc_createAction;
    [_x, 0, ["ACE_MainActions", "Civil_Orders"], _action] call ace_interact_menu_fnc_addActionToClass;
    _action = ["Civil_Go_away", localize "STR_BTC_HAM_ACTION_ORDERS_GOAWAY", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk1_ca.paa", {[3, _target] call FUNC(int,orders);}, {alive _target}] call ace_interact_menu_fnc_createAction;
    [_x, 0, ["ACE_MainActions", "Civil_Orders"], _action] call ace_interact_menu_fnc_addActionToClass;
    _action = ["Ask_Info", localize "STR_BTC_HAM_ACTION_ORDERS_ASKINFO", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk_ca.paa", {[_target,false] spawn FUNC(info,ask);}, {alive _target && {[_player, _target, ["isnothandcuffed", "isnotsurrendering", "isnotsitting"]] call ace_common_fnc_canInteractWith} && {side _target isEqualTo civilian}}] call ace_interact_menu_fnc_createAction;
    [_x, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToClass;
    _action = ["Ask_Reputation", localize "STR_BTC_HAM_ACTION_ORDERS_ASKREP", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk_ca.paa", {[_target] spawn FUNC(info,ask_reputation);}, {alive _target && {[_player, _target, ["isnothandcuffed", "isnotsurrendering", "isnotsitting"]] call ace_common_fnc_canInteractWith} && {side _target isEqualTo civilian}}] call ace_interact_menu_fnc_createAction;
    [_x, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToClass;
    _action = ["Give_food", localize "STR_BTC_HAM_ACTION_GIVEFOOD", "\z\ace\addons\common\data\icon_banana_ca.paa", {[player, _target] call FUNC(int,foodGive)}, {alive _target && {btc_rep_food in items player}}] call ace_interact_menu_fnc_createAction;
    [_x, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToClass;
...
[player, 1, ["ACE_SelfActions", "btc_ace_Actions"], _action] call ace_interact_menu_fnc_addActionToObject;
    //Debug-Mode
    _action = ["Debug_off", "Debug", ["core\img\debug_on.paa", "#006400"], {[false] call FUNC(debug,debug_mode);}, {btc_debug}] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
    _action = ["Debug_on", "Debug", ["core\img\debug_on.paa", "#FF0000"], {[] call FUNC(debug,debug_mode);}, {!btc_debug}] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
    //Debug-Graph
    ...
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
    //Debug-Cities
    _action = ["Debug_cities_off", "Cities", ["core\img\debug_cities.paa", "#006400"], { [false] call FUNC(debug,cities);}, {btc_debug_cities}] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
    ...
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
    //Debug-Hideouts
    _action = ["Debug_hideouts_off", "Hideouts", ["\a3\ui_f\data\Map\Markers\Military\warning_CA.paa", "#006400"], {[false] call FUNC(debug,hideouts);}, {btc_debug_hideouts}] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
    ...
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
    //Debug-Cache
    _action = ["Debug_cache_off", "Cache", ["core\img\debug_cache.paa", "#006400"], {[false] call FUNC(debug,cache);}, {btc_debug_cache}] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
    ...
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
    //Debug-Fob Supplies
    _action = ["Debug_fob_supplies_off", "FOB supplies", ["\A3\ui_f\data\igui\cfg\simpleTasks\types\repair_ca.paa", "#006400"], {[false] call FUNC(debug,supplies);}, {btc_debug_fob_supplies}] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "btc_ace_Actions", "Debug"], _action] call ace_interact_menu_fnc_addActionToObject;
...
_actions pushBack ["redeploy", localize "STR_BTC_HAM_ACTION_BIRESPAWN", "\A3\ui_f\data\igui\cfg\simpleTasks\types\run_ca.paa", {
    if ([] call FUNC(fob,redeployCheck)) then {
        [] call FUNC(respawn,force);
    };
...
_actions pushBack ["base", localize "STR_BTC_HAM_ACTION_REDEPLOYBASE", getText (configfile >> "CfgMarkers" >> getMarkerType "btc_base" >> "icon"), {
    if ([] call FUNC(fob,redeployCheck)) then {[_player, btc_respawn_marker, false] call BIS_fnc_moveToRespawnPosition};
}, {!btc_log_placing && {!(player getVariable ["ace_dragging_isCarrying", false]) && {!(_target getVariable ["btc_log_isBeingPlaced", false])}}}, FUNC(fob,redeploy), "Base"];
_actions pushBack ["rallypoints", localize "STR_BTC_HAM_ACTION_REDEPLOYRALLY", "\A3\ui_f\data\igui\cfg\simpleTasks\types\wait_ca.paa", {}, {!btc_log_placing && {!(player getVariable ["ace_dragging_isCarrying", false]) && {!(_target getVariable ["btc_log_isBeingPlaced", false])}}}, FUNC(fob,redeploy), ""];
...
} forEach _actions;
{
    ...
    _action = ["FOB" + _cardinal, localize _cardinal, "\A3\ui_f\data\igui\cfg\simpleTasks\types\map_ca.paa", {}, {true}, FUNC(fob,redeploy), _degrees] call ace_interact_menu_fnc_createAction;
...
if (btc_p_arsenal_Restrict isNotEqualTo 0) then {[btc_gear_object, btc_p_arsenal_Type, btc_p_arsenal_Restrict, btc_custom_arsenal] call FUNC(arsenal,data);};

//Door
_action = ["door_break", localize "STR_BTC_HAM_ACTION_DOOR_BREAK", "\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa", {
    [FUNC(door,break)] call CBA_fnc_execNextFrame;
}, {"ACE_wirecutter" in items player}] call ace_interact_menu_fnc_createAction;
[player, 1, ["ACE_SelfActions", "ACE_Equipment"], _action] call ace_interact_menu_fnc_addActionToObject;

//Flag
if (btc_p_flag > 1) then {
    private _action = ["btc_flag_deployPlayer", localize "STR_BTC_HAM_ACTION_VEHINIT_DEPLOYFLAG", "\A3\ui_f\data\map\markers\handdrawn\flag_CA.paa", {}, {getForcedFlagTexture _target isEqualTo ""}, FUNC(flag,deploy)] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "ACE_Equipment"], _action] call ace_interact_menu_fnc_addActionToObject;
